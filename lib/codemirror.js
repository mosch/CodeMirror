...
(function(mod) {
  ...
  function Display(place, doc, input) {
    ...
    d.wrapper = elt("div", [d.scrollbarH, d.scrollbarV, d.scrollbarFiller,
                            d.gutterFiller, d.scroller], "CodeMirror");
  ...
  function registerEventHandlers(cm) {
    ...
    function finishTouch() {
      if (d.touchActive) setTimeout(function() {d.touchActive = false;}, 1000);
    };
    ...
    function reFocus() { if (cm.state.focused) setTimeout(function() { d.input.focus(); }, 0); }
